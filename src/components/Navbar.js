    ...
    <nav className="bg-white shadow-elegant">
          ...
          <div className="flex">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              <Link
                to="/growth"
                className={`inline-flex items-center px-1 pt-1 border-b-2 ${
                  isActive('/growth') ? 'border-secondary' : 'border-transparent'
                } ${isActive('/growth')} hover:text-secondary transition-colors`}
              >
                <FaChartLine className="mr-2" /> Growth
              </Link>
              <Link
                to="/api"
                className={`inline-flex items-center px-1 pt-1 border-b-2 ${
      ...
      <div className="sm:hidden border-t border-neutral pt-2 pb-3">
        <div className="flex justify-around">
          ...
          >
            <FaMoneyBillWave className="text-lg mb-1" />
            Pay
          </Link>
          <Link
            to="/growth"
            className={`flex flex-col items-center px-3 py-2 text-sm font-medium ${isActive('/growth')} hover:text-secondary transition-colors`}
          >
